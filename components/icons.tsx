...
export function FolderPlusIcon(props: any) {
    return (
        <>
...
export function RectangleStackIcon(props: any) {
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg"
                fill="none"
...
export function ArrowLongLeft(props: any) {
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg"
                fill="none"
...
export function ArrowCicleLeft(props: any) {
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg"
                fill="none"
...
export function ArrowCicleRight(props: any) {
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg"
                fill="none"
...
export function EllipsisVIcon(props: any) {
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg"
                fill="none" viewBox="0 0 24 24"
...
export function ChevronDoubleRightIcon(props: any) {
    return (
        <>
            <svg xmlns="http://www.w3.org/2000/svg"
                fill="none" viewBox="0 0 24 24"
